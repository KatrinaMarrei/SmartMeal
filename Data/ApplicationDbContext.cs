        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Dish>().HasData(
                ...
                new Dish
                {
                    ...
                    Carbs = 34m,
                    CookingTime = 45,
                    ImageUrl = "/images/dishes/seeded/cottage-cheese-casserole.png",
                ...
                new Dish
                {
                    ...
                    Carbs = 55m,
                    CookingTime = 40,
                    ImageUrl = "/images/dishes/seeded/buckwheat-with-turkey.png",
                ...
                new Dish
                {
                    ...
                    Carbs = 48m,
                    CookingTime = 45,
                    ImageUrl = "/images/dishes/seeded/vegetable-bean-stew.png",
                ...
                new Dish
                {
                    ...
                    Carbs = 35m,
                    CookingTime = 10,
                    ImageUrl = "/images/dishes/seeded/chicken-sandwich.png",
                ...
                new Dish { Id = 9, Name = "Омлет со шпинатом и сыром", Description = "1. Взбейте яйца с молоком и солью. 2. Прогрейте шпинат на сковороде с маслом. 3. Залейте яйцами, посыпьте сыром и готовьте под крышкой.", CategoryId = 1, Calories = 330m, Proteins = 24m, Fats = 24m, Carbs = 5m, CookingTime = 12, ImageUrl = "/images/dishes/seeded/spinach-cheese-omelet.png", IngredientsList = "Яйца 2 шт., молоко 40 мл, шпинат 60 г, твердый сыр 25 г, сливочное масло 5 г, соль 1 г, черный перец 1 г", MainIngredient = "Яйца", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 10, Name = "Греческий йогурт с орехами", Description = "1. Переложите йогурт в миску. 2. Добавьте орехи, ягоды и мед. 3. Посыпьте семенами чиа и подавайте охлажденным.", CategoryId = 1, Calories = 290m, Proteins = 20m, Fats = 14m, Carbs = 23m, CookingTime = 5, ImageUrl = "/images/dishes/seeded/greek-yogurt-with-nuts.png", IngredientsList = "Греческий йогурт 170 г, грецкие орехи 15 г, ягоды 60 г, мед 8 г, семена чиа 5 г", MainIngredient = "Греческий йогурт", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 11, Name = "Сырники из рисовой муки", Description = "1. Смешайте творог, яйцо, рисовую муку и немного сахара. 2. Сформируйте сырники. 3. Обжарьте на минимуме масла до румяной корочки.", CategoryId = 1, Calories = 340m, Proteins = 25m, Fats = 13m, Carbs = 30m, CookingTime = 25, ImageUrl = "/images/dishes/seeded/rice-flour-syrniki.png", IngredientsList = "Творог 5% 180 г, яйцо 1 шт., рисовая мука 25 г, сахар 8 г, растительное масло 5 г, соль 1 г", MainIngredient = "Творог", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 12, Name = "Авокадо с яйцом и томатами", Description = "1. Разрежьте авокадо и выньте часть мякоти. 2. Вбейте яйцо, добавьте томаты и специи. 3. Запекайте при 180 градусах до готовности яйца.", CategoryId = 1, Calories = 360m, Proteins = 14m, Fats = 31m, Carbs = 9m, CookingTime = 20, ImageUrl = "/images/dishes/seeded/avocado-with-egg-and-tomatoes.png", IngredientsList = "Авокадо 120 г, яйцо 1 шт., томаты черри 70 г, оливковое масло 5 г, соль 1 г, черный перец 1 г, зелень 5 г", MainIngredient = "Авокадо", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 13, Name = "Рисовая каша с тыквой", Description = "1. Нарежьте тыкву кубиками и потушите с водой. 2. Добавьте рис, молоко и соль. 3. Варите до мягкости, затем добавьте масло.", CategoryId = 1, Calories = 300m, Proteins = 8m, Fats = 7m, Carbs = 52m, CookingTime = 30, ImageUrl = "/images/dishes/seeded/rice-porridge-with-pumpkin.png", IngredientsList = "Рис 50 г, тыква 120 г, молоко 180 мл, сливочное масло 5 г, сахар 8 г, соль 1 г", MainIngredient = "Тыква", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 14, Name = "Булгур с курицей и овощами", Description = "1. Обжарьте курицу с луком на масле. 2. Добавьте булгур, морковь, перец и воду. 3. Тушите под крышкой до готовности крупы.", CategoryId = 2, Calories = 510m, Proteins = 38m, Fats = 13m, Carbs = 58m, CookingTime = 35, ImageUrl = "/images/dishes/seeded/bulgur-with-chicken-and-vegetables.png", IngredientsList = "Булгур 75 г, куриное филе 140 г, морковь 50 г, болгарский перец 70 г, лук 35 г, оливковое масло 8 г, соль 2 г, паприка 2 г", MainIngredient = "Курица", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 15, Name = "Чечевичный суп с томатами", Description = "1. Промойте чечевицу. 2. Варите ее с томатами, морковью и луком. 3. Добавьте специи, пробейте часть супа блендером и подавайте.", CategoryId = 2, Calories = 320m, Proteins = 18m, Fats = 7m, Carbs = 46m, CookingTime = 35, ImageUrl = "/images/dishes/seeded/lentil-tomato-soup.png", IngredientsList = "Красная чечевица 70 г, томаты 150 г, морковь 60 г, лук 40 г, оливковое масло 6 г, соль 2 г, зира 1 г, зелень 5 г", MainIngredient = "Чечевица", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 16, Name = "Паста с тунцом и томатами", Description = "1. Отварите пасту до готовности. 2. Прогрейте томаты с тунцом и чесноком. 3. Соедините пасту с соусом и посыпьте зеленью.", CategoryId = 2, Calories = 520m, Proteins = 34m, Fats = 14m, Carbs = 62m, CookingTime = 25, ImageUrl = "/images/dishes/seeded/tuna-tomato-pasta.png", IngredientsList = "Паста из твердых сортов 80 г, тунец консервированный 100 г, томаты 150 г, оливковое масло 8 г, чеснок 5 г, соль 2 г, базилик 2 г", MainIngredient = "Тунец", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 17, Name = "Боул с киноа и нутом", Description = "1. Отварите киноа. 2. Добавьте нут, огурец, томаты и зелень. 3. Заправьте маслом, лимонным соком и специями.", CategoryId = 2, Calories = 460m, Proteins = 17m, Fats = 16m, Carbs = 58m, CookingTime = 30, ImageUrl = "/images/dishes/seeded/quinoa-chickpea-bowl.png", IngredientsList = "Киноа 65 г, нут отварной 100 г, огурец 80 г, томаты 100 г, оливковое масло 10 г, лимонный сок 10 мл, соль 2 г, петрушка 5 г", MainIngredient = "Киноа", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 18, Name = "Тефтели из индейки с рисом", Description = "1. Смешайте фарш индейки с рисом, яйцом и солью. 2. Сформируйте тефтели. 3. Тушите в томатном соусе до готовности.", CategoryId = 2, Calories = 480m, Proteins = 36m, Fats = 14m, Carbs = 50m, CookingTime = 45, ImageUrl = "/images/dishes/seeded/turkey-meatballs-with-rice.png", IngredientsList = "Фарш индейки 150 г, рис отварной 120 г, яйцо 0,5 шт., томатный соус 120 г, лук 35 г, растительное масло 5 г, соль 2 г", MainIngredient = "Индейка", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 19, Name = "Борщ с говядиной", Description = "1. Отварите говядину до мягкости. 2. Добавьте свеклу, капусту, картофель и морковь. 3. Варите до готовности и подавайте со сметаной.", CategoryId = 2, Calories = 410m, Proteins = 28m, Fats = 17m, Carbs = 36m, CookingTime = 80, ImageUrl = "/images/dishes/seeded/beef-borscht.png", IngredientsList = "Говядина 120 г, свекла 100 г, капуста 90 г, картофель 100 г, морковь 50 г, лук 35 г, сметана 20 г, соль 2 г", MainIngredient = "Говядина", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 20, Name = "Рис с креветками и овощами", Description = "1. Отварите рис. 2. Быстро обжарьте креветки с овощами и соевым соусом. 3. Добавьте рис и прогрейте все вместе.", CategoryId = 2, Calories = 430m, Proteins = 30m, Fats = 10m, Carbs = 55m, CookingTime = 25, ImageUrl = "/images/dishes/seeded/shrimp-vegetable-rice.png", IngredientsList = "Рис 70 г, креветки очищенные 140 г, зеленый горошек 50 г, морковь 50 г, соевый соус 10 мл, кунжутное масло 6 г, соль 1 г", MainIngredient = "Креветки", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 21, Name = "Куриная грудка с брокколи", Description = "1. Приправьте куриную грудку солью и специями. 2. Запеките вместе с брокколи и маслом. 3. Дайте мясу отдохнуть 5 минут перед подачей.", CategoryId = 3, Calories = 360m, Proteins = 42m, Fats = 15m, Carbs = 12m, CookingTime = 30, ImageUrl = "/images/dishes/seeded/chicken-breast-with-broccoli.png", IngredientsList = "Куриная грудка 170 г, брокколи 180 г, оливковое масло 10 г, соль 2 г, паприка 2 г, чеснок сушеный 1 г", MainIngredient = "Курица", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 22, Name = "Говядина с цветной капустой", Description = "1. Обжарьте ломтики говядины на масле. 2. Добавьте цветную капусту и специи. 3. Тушите до мягкости мяса и овощей.", CategoryId = 3, Calories = 450m, Proteins = 35m, Fats = 28m, Carbs = 12m, CookingTime = 40, ImageUrl = "/images/dishes/seeded/beef-with-cauliflower.png", IngredientsList = "Говядина 160 г, цветная капуста 200 г, сливочное масло 10 г, оливковое масло 5 г, соль 2 г, черный перец 1 г", MainIngredient = "Говядина", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 23, Name = "Фриттата с овощами", Description = "1. Обжарьте кабачок, перец и шпинат. 2. Залейте яйцами с сыром. 3. Доведите до готовности на сковороде или в духовке.", CategoryId = 3, Calories = 380m, Proteins = 24m, Fats = 27m, Carbs = 11m, CookingTime = 25, ImageUrl = "/images/dishes/seeded/vegetable-frittata.png", IngredientsList = "Яйца 3 шт., кабачок 80 г, болгарский перец 70 г, шпинат 40 г, сыр 30 г, оливковое масло 8 г, соль 2 г", MainIngredient = "Яйца", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 24, Name = "Тофу с овощами в соевом соусе", Description = "1. Нарежьте тофу и овощи. 2. Обжарьте их с имбирем и соевым соусом. 3. Посыпьте кунжутом и подавайте горячим.", CategoryId = 3, Calories = 350m, Proteins = 22m, Fats = 20m, Carbs = 18m, CookingTime = 20, ImageUrl = "/images/dishes/seeded/tofu-vegetable-stir-fry.png", IngredientsList = "Тофу 180 г, брокколи 100 г, болгарский перец 80 г, соевый соус 15 мл, кунжутное масло 8 г, имбирь 5 г, кунжут 5 г", MainIngredient = "Тофу", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 25, Name = "Котлеты из лосося с салатом", Description = "1. Измельчите лосось с яйцом и зеленью. 2. Сформируйте котлеты и обжарьте на масле. 3. Подайте с салатом из огурца и зелени.", CategoryId = 3, Calories = 470m, Proteins = 34m, Fats = 31m, Carbs = 9m, CookingTime = 30, ImageUrl = "/images/dishes/seeded/salmon-patties-with-salad.png", IngredientsList = "Филе лосося 160 г, яйцо 0,5 шт., огурец 100 г, листовой салат 50 г, оливковое масло 10 г, лимонный сок 8 мл, соль 2 г", MainIngredient = "Лосось", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 26, Name = "Перец, фаршированный овощами и рисом", Description = "1. Смешайте отварной рис с овощами и томатами. 2. Наполните перец начинкой. 3. Тушите в томатном соусе до мягкости.", CategoryId = 3, Calories = 330m, Proteins = 10m, Fats = 9m, Carbs = 54m, CookingTime = 50, ImageUrl = "/images/dishes/seeded/stuffed-pepper-with-rice.png", IngredientsList = "Болгарский перец 180 г, рис отварной 130 г, морковь 60 г, лук 40 г, томатный соус 120 г, растительное масло 7 г, соль 2 г", MainIngredient = "Болгарский перец", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 27, Name = "Теплый салат с печенью и яблоком", Description = "1. Быстро обжарьте куриную печень с луком. 2. Добавьте яблоко и листья салата. 3. Заправьте маслом и бальзамическим уксусом.", CategoryId = 3, Calories = 390m, Proteins = 29m, Fats = 20m, Carbs = 24m, CookingTime = 25, ImageUrl = "/images/dishes/seeded/warm-liver-apple-salad.png", IngredientsList = "Куриная печень 160 г, яблоко 90 г, листовой салат 60 г, лук 35 г, оливковое масло 10 г, бальзамический уксус 8 мл, соль 2 г", MainIngredient = "Куриная печень", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 28, Name = "Овощные палочки с хумусом", Description = "1. Нарежьте морковь, огурец и перец брусочками. 2. Смешайте хумус с лимонным соком и паприкой. 3. Подавайте овощи с соусом.", CategoryId = 4, Calories = 220m, Proteins = 8m, Fats = 11m, Carbs = 24m, CookingTime = 10, ImageUrl = "/images/dishes/seeded/vegetable-sticks-with-hummus.png", IngredientsList = "Хумус 70 г, морковь 70 г, огурец 80 г, болгарский перец 80 г, лимонный сок 5 мл, паприка 1 г", MainIngredient = "Хумус", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 29, Name = "Яблоко с арахисовой пастой", Description = "1. Нарежьте яблоко дольками. 2. Смажьте арахисовой пастой. 3. Посыпьте корицей и подавайте сразу.", CategoryId = 4, Calories = 210m, Proteins = 5m, Fats = 10m, Carbs = 27m, CookingTime = 5, ImageUrl = "/images/dishes/seeded/apple-with-peanut-butter.png", IngredientsList = "Яблоко 150 г, арахисовая паста 18 г, корица 1 г", MainIngredient = "Яблоко", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 30, Name = "Протеиновый творог с какао", Description = "1. Смешайте творог с какао и йогуртом. 2. Добавьте подсластитель по вкусу. 3. Охладите 5 минут и подавайте.", CategoryId = 4, Calories = 240m, Proteins = 30m, Fats = 8m, Carbs = 12m, CookingTime = 5, ImageUrl = "/images/dishes/seeded/protein-cottage-cheese-cocoa.png", IngredientsList = "Творог 2% 180 г, натуральный йогурт 40 г, какао 5 г, подсластитель 1 г, ванилин 1 г", MainIngredient = "Творог", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 31, Name = "Рисовые хлебцы с авокадо", Description = "1. Разомните авокадо с лимонным соком и солью. 2. Намажьте массу на рисовые хлебцы. 3. Добавьте томаты и зелень.", CategoryId = 4, Calories = 230m, Proteins = 4m, Fats = 14m, Carbs = 24m, CookingTime = 7, ImageUrl = "/images/dishes/seeded/rice-cakes-with-avocado.png", IngredientsList = "Рисовые хлебцы 25 г, авокадо 80 г, томаты черри 60 г, лимонный сок 5 мл, соль 1 г, зелень 5 г", MainIngredient = "Авокадо", IsForChildren = false, IsCustom = false, CreatedByUserProfileId = null },
                new Dish { Id = 32, Name = "Смузи с кефиром и бананом", Description = "1. Нарежьте банан. 2. Взбейте его с кефиром, ягодами и овсяными хлопьями. 3. Подавайте сразу после приготовления.", CategoryId = 4, Calories = 260m, Proteins = 11m, Fats = 6m, Carbs = 42m, CookingTime = 5, ImageUrl = "/images/dishes/seeded/kefir-banana-smoothie.png", IngredientsList = "Кефир 1% 200 мл, банан 90 г, ягоды 60 г, овсяные хлопья 15 г, мед 5 г", MainIngredient = "Кефир", IsForChildren = true, IsCustom = false, CreatedByUserProfileId = null }
            );
